...
String buildTabbyCardSnippetUrl({
  ...
  final trimmed = widgetsBaseUrl.endsWith('/')
      ...
      : widgetsBaseUrl;
  return '$trimmed/tabby-card.html'
      '?price=$price'
...
class TabbyCardSnippet extends StatefulWidget {
  const TabbyCardSnippet({
    required this.price,
  ...
  @override
  State<TabbyCardSnippet> createState() => _TabbyCardSnippetState();
}

class _TabbyCardSnippetState extends State<TabbyCardSnippet> {
  double height = 136;
  ...
  String _buildAddress() => buildTabbyCardSnippetUrl(
  ...
  @override
  void didUpdateWidget(TabbyCardSnippet oldWidget) {
